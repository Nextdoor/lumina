...
func TestMetricNameConstants(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:         "SavingsPlanObservedUnusedCommitment",
			constant:     MetricSavingsPlanObservedUnusedCommitment,
			actualMetric: m.SavingsPlanObservedUnusedCommitment,
		},
		{
			name:         "SavingsPlanUtilizationObservationTimestampSeconds",
			constant:     MetricSavingsPlanUtilizationObservationTimestampSeconds,
			actualMetric: m.SavingsPlanUtilizationObservationTimestamp,
		},
		{
...
func TestMetricNameConstantsAreUnique(t *testing.T) {
	constants := []string{
		...
		MetricSavingsPlanObservedUnusedCommitment,
		MetricSavingsPlanUtilizationObservationTimestampSeconds,
...
func TestMetricNameConstantsFormat(t *testing.T) {
	constants := map[string]string{
		...
		"MetricSavingsPlanObservedUnusedCommitment":               MetricSavingsPlanObservedUnusedCommitment,
		"MetricSavingsPlanUtilizationObservationTimestampSeconds": MetricSavingsPlanUtilizationObservationTimestampSeconds,
