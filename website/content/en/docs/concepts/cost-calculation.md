...
description: "How Lumina calculates per-instance costs using Savings Plans and Reserved Instance allocation"
weight: 20
---
...
**EC2 Instance Savings Plans** ([docs](https://docs.aws.amazon.com/savingsplans/latest/userguide/sp-types.html#sp-ec2-instance)):
...
**Compute Savings Plans** ([docs](https://docs.aws.amazon.com/savingsplans/latest/userguide/sp-types.html#sp-compute)):
...
- **Existing Coverage**: See [Simplified Model Decisions](#simplified-model-decisions)
